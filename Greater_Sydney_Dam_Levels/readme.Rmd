...
# Interpolate values every month
interpolated_df <- approx(x = df$date, y = df$values, xout = seq(as.Date("2016/1/1"), as.Date("2019/1/1"), "months"))

# Plot the interpolated values
plot(interpolated_df$x, interpolated_df$y, type = "b")
