...
Using the current storage level and the rolling averages sampled at 1,7,30,60,90 and 120 days can estimate the "Spillover" and "Day Zero" days based off a range of rolling averages. Users worried about drought should focus on the 7 and 30 day forecasts as measures of the severity of recent conditions.
Users can also take solace knowing there is a degree of mean reversion via the 90 and 120 day averages.
